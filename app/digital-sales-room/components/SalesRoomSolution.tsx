...
export default function SalesRoomSolution({ purple = false }: { purple?: boolean }) {
  return (
    <FeatureGridSection
      id="solution"
      eyebrow="THE SOLUTION"
      heading="One room. Both parties. Real-time."
      lede="The Digital Sales Room replaces scattered email threads with a shared workspace where the negotiation happens live."
      features={features}
      purple={purple}
    />
  );
