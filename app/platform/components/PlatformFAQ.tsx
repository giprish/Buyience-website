...
export default function PlatformFAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Grow is $99/mo and Pro is $179/mo (the AI Quote Engine is included in Pro, or available as a $49/mo add-on on Grow), with custom Enterprise pricing for high-volume operations. Every plan starts with a 14-day free trial — no card required.",
    },
  ];
