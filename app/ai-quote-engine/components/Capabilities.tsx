...
export default function Capabilities({ purple = false }: { purple?: boolean }) {
  return (
    <CapabilitiesChipGridSection
      id="capabilities"
      eyebrow="CAPABILITIES"
      heading="Everything you need to price with confidence."
      lede="From the first quote to the final agreement, the AI guides every pricing decision with data — and keeps you in control."
      items={CAPABILITIES}
      purple={purple}
    />
  );
