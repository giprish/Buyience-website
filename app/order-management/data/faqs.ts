export type OrderManagementFaqItem = {
  q: string;
  a: string;
};

export const orderManagementFaqs: OrderManagementFaqItem[] = [
  {
...
export function orderManagementFaqJsonLd() {
  return {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: orderManagementFaqs.map((faq) => ({
      "@type": "Question",
      name: faq.q,
      acceptedAnswer: {
        "@type": "Answer",
