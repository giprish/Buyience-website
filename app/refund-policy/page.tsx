  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto max-w-3xl flex-grow px-6 py-16 sm:py-20">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#171241] sm:text-4xl">Refund Policy</h1>
        ...
        <div className="mt-10 space-y-6 text-[15.5px] leading-relaxed text-[#5B5F76]">
          ...
          <h2 className="text-xl font-bold text-[#171241]">How to request a refund</h2>
          <p>
            Email{" "}
          ...
          <h2 className="text-xl font-bold text-[#171241]">Cancellations</h2>
          <p>
