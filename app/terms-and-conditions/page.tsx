  ...
  return (
    <MarketingLayout cta={false}>
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
        <h1 className="text-4xl font-extrabold tracking-normal text-[#1B1033] sm:text-5xl">Terms & Conditions</h1>
        ...
        <div className="mt-10 space-y-6 text-[15.5px] leading-relaxed text-[#5A4B7C]">
          ...
          <h2 className="text-xl font-bold text-[#1B1033]">Services</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#1B1033]">Acceptable use</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#1B1033]">Subscriptions & billing</h2>
          <p>
