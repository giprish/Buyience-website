  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto max-w-3xl flex-grow px-6 py-16 sm:py-20">
        <h1 className="text-3xl font-semibold tracking-normal text-[#17265C] sm:text-4xl">Privacy Policy</h1>
        ...
        <div className="prose-buyience mt-10 space-y-6 text-[15.5px] leading-relaxed text-[#5B5F76]">
          ...
          <h2 className="text-xl font-bold text-[#17265C]">Information we collect</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#17265C]">How we use information</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#17265C]">Your rights</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-[#17265C]">Contact</h2>
          <p>
