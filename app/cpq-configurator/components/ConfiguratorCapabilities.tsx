...
export default function ConfiguratorCapabilities({ purple = false }: { purple?: boolean }) {
  return (
    <CapabilitiesChipGridSection
      id="capabilities"
      eyebrow="CORE CAPABILITIES"
      heading="Everything you need to configure products."
      lede="From option groups to conflict rules, dynamic pricing to quote integration — one system for complex products."
      items={CAPABILITIES}
      purple={purple}
    />
  );
