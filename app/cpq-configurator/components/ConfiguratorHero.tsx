          ...
          <div className="cfg" aria-label="Interactive configurator demo">
            <div className="cfg-head">
              <div>
                ...
                <div className="cfg-sub">Base {format(1200)} · 3 option groups · 27 valid combinations</div>
              </div>
            ...
            <div className="grp">
              ...
              <div className="opts" role="group" aria-label="Memory options">
                ...
                >
                  16 GB<span className="pr">+{format(0)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  32 GB<span className="pr">+{format(180)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  64 GB<span className="pr">+{format(420)}</span>
                </button>
              </div>
            </div>
            ...
            <div className="grp">
              ...
              <div className="opts" role="group" aria-label="Storage options">
                ...
                >
                  500 GB<span className="pr">+{format(0)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  1 TB<span className="pr">+{format(140)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  2 TB<span className="pr">+{format(320)}</span>
                </button>
              </div>
            </div>
            ...
            <div className="grp">
              ...
              <div className="opts" role="group" aria-label="Processor options">
                ...
                >
                  Standard<span className="pr">+{format(0)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  Pro<span className="pr">+{format(450)}</span>
                </button>
                <button
                  type="button"
                  className="opt"
                ...
                >
                  Enterprise<span className="pr">+{format(900)}</span>
                </button>
              </div>
            </div>
